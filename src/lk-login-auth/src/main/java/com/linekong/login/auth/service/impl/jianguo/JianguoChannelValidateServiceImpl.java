 ...
 * 
 */
package com.linekong.login.auth.service.impl.jianguo;
 ...
 *
 */
public class JianguoChannelValidateServiceImpl implements IVerifierRuleService {
	...
	public boolean validate(Map<String, String> channelInfoMap,
		...
		//访问地址:https://api.9isy.com/api/cp/user/check
